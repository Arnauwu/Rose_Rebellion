...
public:
	...
	bool DrawWorldTextureScaledSection(SDL_Texture* texture, const SDL_Rect& srcRect, const SDL_Rect& destRect, float speed = 1.0f) const;
	...
	bool DrawLineUnscaled(int x1, int y1, int x2, int y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a = 255, bool useCamera = true) const;

	bool DrawCircle(int x1, int y1, int redius, Uint8 r, Uint8 g, Uint8 b, Uint8 a = 255, bool useCamera = true) const;
	bool DrawCircleUnscaled(int x1, int y1, int redius, Uint8 r, Uint8 g, Uint8 b, Uint8 a = 255, bool useCamera = true) const;
