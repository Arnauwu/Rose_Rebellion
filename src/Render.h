...
public:
	...
	bool DrawRotatedTexture(SDL_Texture* texture, int x, int y, const SDL_Rect* section, float adjustableScale, double angle , int pivotX, int pivotY, SDL_FlipMode flip) const;
