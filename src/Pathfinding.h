...
public:
    ...
    int blockedGid ; //Gid of the tiles that block the path - Important adjust this value to your map
    int highCostGid; //Gid of the tiles that have high cost - Important adjust this value to your map
};
